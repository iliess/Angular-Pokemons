...
var PokemonsService = /** @class */ (function () {
    ...
    PokemonsService.prototype.getPokemons = function () {
        var _this = this;
        return this.http.get(this.pokemonsUrl).pipe(operators_1.tap(function (_) { return _this.log('fetched pokemons'); }), operators_1.catchError(this.handleError('getPokermons', [])));
    };
    ...
    PokemonsService.prototype.getPokemon = function (id) {
        ...
        return this.http.get(url).pipe(operators_1.tap(function (_) { return _this.log("fetched pokemon id = " + id); }), operators_1.catchError(this.handleError("getPokermon id = " + id)));
    };
    PokemonsService.prototype.updatePokemon = function (pokemon) {
        ...
        return this.http.put(this.pokemonsUrl, pokemon, httpOptions).pipe(operators_1.tap(function (_) { return _this.log("updated pokemon id = " + pokemon.id); }), operators_1.catchError(this.handleError("updated Pokermon")));
    };
    PokemonsService.prototype.deletePokemon = function (pokemon) {
        ...
        return this.http.delete(url, httpOptions).pipe(operators_1.tap(function (_) { return _this.log("deleted pokemon id = " + pokemon.id); }), operators_1.catchError(this.handleError("deleted Pokermon")));
    };
